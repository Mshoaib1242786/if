...
{
    document.getElementById('resultShowGold').innerText="zakat is not applicable";
...
function silverCal(){
    ...
    {
        document.getElementById('resultShowSilver').innerText="zakay is not applicable";
    }
}
...
{
    document.getElementById('resultShowCash').innerText="zakat is not applicable";
